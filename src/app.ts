...
async function server() {
  ...
  app.use('/adjustmentnote', authenticateTokenAccessImage, express.static('generated/adjustmentnote'))
  app.use('/report', authenticateTokenAccessImage, express.static('generated/report'))
