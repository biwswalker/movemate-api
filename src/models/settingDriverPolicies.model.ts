...
export class SettingDriverPolicies extends TimeStamps {
    @Field({ nullable: true })
    @Property()
...
const SettingDriverPoliciesModel = getModelForClass(SettingDriverPolicies)

export default SettingDriverPoliciesModel