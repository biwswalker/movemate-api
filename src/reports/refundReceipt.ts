...
import { NonTaxRefundReceiptHeaderComponent } from './components/nonTaxRefundReceipt/header'
import { NonTaxRefundReceiptFooterComponent } from './components/nonTaxRefundReceipt/footer'
...
export async function generateRefundReceipt(
  ...
  nomoredata = true
  NonTaxRefundReceiptFooterComponent(doc, refundNote)
  // isOiginal = false

  // // Copy section
  // await doc.addPage()
  // nomoredata = false
  // NonTaxRefundReceiptHeaderComponent(doc, _user, receipt, currentPage, currentPage, isOiginal)
  ...
  // })
  // nomoredata = true
  // NonTaxRefundReceiptHeaderComponent(doc, receipt)
